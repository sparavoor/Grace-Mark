      ...
      <div className="w-full max-w-md">
        <FadeInUp className="text-center mb-12 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-slate-400 font-medium uppercase text-[9px] tracking-[0.3em]">Pulikkal Division Management Protocol</p>
          </div>
        </FadeInUp>
        ...
        <FadeInUp delay={0.1} className="card-premium p-8 md:p-12 border-slate-200/60 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-3">
              <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em]">Operator Identifier</label>
              <input 
                name="username" 
                type="text" 
                placeholder="Sector or Admin ID" 
                required 
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em]">Activation Cipher</label>
              <input 
                name="password" 
                type="password" 
                placeholder="••••••••" 
            ...
            <button type="submit" className="btn-primary w-full py-5 text-[11px] font-semibold uppercase tracking-[0.4em] shadow-2xl group">
              Authorize Credentials <ArrowRight className="w-4 h-4 ml-3 group-hover:translate-x-1 transition-transform" />
            </button>
          </form>
          ...
          <div className="mt-14 pt-8 border-t border-slate-50 text-center flex flex-col items-center gap-3">
            <div className="flex items-center gap-2 text-[9px] font-medium text-slate-300 uppercase tracking-widest leading-none">
                ...
                <span>Encrypted Node Access Port</span>
            </div>
            <p className="text-[8px] text-slate-300 font-normal uppercase tracking-[0.2em]">
              &copy; 2026 SSF Pulikkal Division Systems
            </p>
          </div>
        </FadeInUp>
      </div>
